/*Class DrawableRectangle inherited from Rectangle and implements Drawable and Moveable.
...
public class DrawableRectangle extends Rectangle implements Drawable, Movable {
    ...
    public String draw() {
        ...
        return "draw a rectangle with top left corner at (" + x + "," + y + ") with width=" + width + " lenght=" + lenght;
    }
